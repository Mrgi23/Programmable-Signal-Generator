...
TEST_F(FIRTest, inverseSincTooHighOrder) { EXPECT_THROW(inverseSinc(0.49, 0.0025), length_error); }
...
TEST_F(FIRTest, halfBandTooHighOrder) { EXPECT_THROW(halfband(200.0, 0.23), length_error); }
